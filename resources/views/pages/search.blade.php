<div class="space-y-10">
    <h3 class="heading bg-transparent text-2xl uppercase font-light">
        Result for: <b class="font-black">{{ $query }}</b>
    </h3>
    ...
    <div class="grid lg:grid-cols-[auto_350px] gap-10">
        ...
        <livewire:components.news-style-one :posts="$more" heading="More News" />
