    ...
    <div class="wrapper max-w-[1090px] mx-auto flex items-center justify-between gap-5 h-full relative">
        ...
        <ul class="navmenu hidden md:flex items-center gap-5">
            ...
            <li class="relative" x-data={open:false} @mouseover='open=true' @mouseout='open=false'>
                ...
                <div x-cloak x-show="open" class="absolute w-[500px] top-full p-5 bg-white rounded-lg shadow-lg border z-[999] left-1/2 -translate-x-1/2">
        ...
        <div class="flex items-center gap-5">
            ...
            <div class="" x-data={open:false}>
                ...
                <form action="{{ route('search') }}" x-show="open" class="absolute w-full h-full top-0 left-0 px-5 py-3 bg-white flex items-center gap-5">
                    <a href="/" class="text-xl font-black">Safona <span class="hidden sm:inline">Media</span></a>
                    <input type="text" name="q" placeholder="search safona..." class="flex-grow bg-zinc-100 px-5 py-3 rounded-full outline-none">
            ...
            @auth
                <div class="relative" x-data={open:false}>
                    ...
                    <div x-show="open" @click.outside="open=false" class="absolute top-full p-3 bg-white z-[999] border rounded-lg right-0">
